...
class Database {
    ...
    public async bulkDocs(docs: Array<PouchDB.Core.PutDocument<Record>>, options?: PouchDB.Core.BulkDocsOptions): Promise<Array<(PouchDB.Core.Response | PouchDB.Core.Error)>> {
        try {
    ...
    public async bulkGet(options?: PouchDB.Core.BulkGetOptions): Promise<PouchDB.Core.BulkGetResponse<{}>> {
        try {
